...
{
    public sealed partial class IconToggleButton : ToggleButton
    {
        ...
        public static readonly DependencyProperty IconSizeProperty =
            DependencyProperty.Register(nameof(IconSize), typeof(double), typeof(SplitViewButton), new PropertyMetadata(48d));
